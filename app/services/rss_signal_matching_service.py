...
def _new_signal_from_item(item: RssItem, match_score: float, candidates: list[str]) -> RssSignal:
    ...
    return RssSignal(
        ...
        event_centroid=coerce_numeric_vector(item.event_embedding),
        entity_centroid=coerce_numeric_vector(item.entity_embedding),
        impact_centroid=coerce_numeric_vector(item.impact_embedding),
        context_centroid=coerce_numeric_vector(item.context_embedding),
